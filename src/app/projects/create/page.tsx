...
function CreateProJect() {
    ...
    const handleSubmitProject = async (e: any) => {
        ...
        const newObj = {
            ...
            finish_date: handleFormatDate(dateFinish),
            time: changeValue.time,
            expense: changeValue.expense,
            state: changeValue.state,
        }

        try {
            const response = await axios.post("http://127.0.0.1:8000/api/projects", newObj);
                                ...
                                <div className={styles["introduce"]}>
                                    ...
                                    <div className={styles["infor__project"]}>
                                            ...
                                            <div className={grid["grid__row"]}>
                                                <div className={grid["grid__column-6"]}>
                                                    ...
                                                    <div className={classNames(styles["infor__item"])}>
                                                        ...
                                                        <input name="name" onChange={handleSetChangeValue} className={classNames(styles["input__infor"], styles["choosen__item-infor"])} required placeholder="Nhập tên dự án" />
                                                    </div>
                                                ...
                                                <div className={grid["grid__column-6"]}>
                                                    <div className={styles["infor__item"]}>
                                                        ...
                                                        <input name="expense" onChange={handleSetChangeValue} className={styles["input__infor"]} required placeholder="Nhập chi phí dự án" />
                                                    </div>
                                                    ...
                                                    <div className={styles["infor__item"]}>
                                                        ...
                                                        <input name="time" onChange={handleSetChangeValue} className={styles["input__infor"]} required placeholder="Nhập thời gian dự tính" />
                                                    </div>
                                        ...
                                        <div className={styles["infor__item"]}>
                                            ...
                                            <textarea name="description" onChange={handleSetChangeValue} className={styles["input__infor"]} required placeholder="Nhập mô tả dự án" />
                                        </div>
                                    </div>
                                </div>
