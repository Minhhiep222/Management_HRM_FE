                        ...
                        <div className={grid["grid__column-12"]}>
                            <div className={styles["content_user"]}>
                                ...
                                <div className={styles["introduce"]}>
                                    <h3 className={styles["title__introduce"]}>Thông Tin Khách Hàng</h3>
                                    <div className={styles["infor__project"]}>
                                        ...
                                        <div className={styles["infor__item"]}>
                                            <div className={styles["title__infor"]}>*Email</div>
                                            <input className={styles["input__infor"]} required placeholder="Nhập Email" />
                                        </div>
                                        <div className={styles["infor__item"]}>
                                            <div className={styles["title__infor"]}>*Số tài khoản</div>
                                            <input className={styles["input__infor"]} required placeholder="Nhập Số Tài Khoản" />
                                        </div>
                                        <div className={styles["infor__item"]}>
                                            <div className={styles["title__infor"]}>*Mô Tả</div>
                                            <textarea className={styles["input__infor"]} required placeholder="Nhập Mô Tả " />
                                        </div>
                                    </div>
                                </div>
